...
export enum RfqKnownErrorCode {
  ...
  BalanceAllowanceValidationFailed = 'BALANCE_ALLOWANCE_VALIDATION_FAILED',
  BalanceValidationFailed = 'BALANCE_VALIDATION_FAILED',
  BalanceValidationSetupFailed = 'BALANCE_VALIDATION_SETUP_FAILED',
  BalanceCheckerUnavailable = 'BALANCE_CHECKER_UNAVAILABLE',
  BuilderAttributionNotAllowed = 'BUILDER_ATTRIBUTION_NOT_ALLOWED',
  ContradictoryLegs = 'CONTRADICTORY_LEGS',
  ExpiredRfq = 'EXPIRED_RFQ',
  ExecutorInsufficientFunds = 'EXECUTOR_INSUFFICIENT_FUNDS',
  FailedToBuildCalldata = 'FAILED_TO_BUILD_CALLDATA',
  FailedToResetNonce = 'FAILED_TO_RESET_NONCE',
  FailedToBuildTx = 'FAILED_TO_BUILD_TX',
  FailedToSendTx = 'FAILED_TO_SEND_TX',
  FailedToSignTx = 'FAILED_TO_SIGN_TX',
  ...
  MakerAllowanceValidationFailed = 'MAKER_ALLOWANCE_VALIDATION_FAILED',
  MakerAllowanceReservedByActiveRfqs = 'MAKER_ALLOWANCE_RESERVED_BY_ACTIVE_RFQS',
  MakerBalanceValidationFailed = 'MAKER_BALANCE_VALIDATION_FAILED',
  MakerBalanceReservedByActiveRfqs = 'MAKER_BALANCE_RESERVED_BY_ACTIVE_RFQS',
  MakerConfirmationTimedOut = 'MAKER_CONFIRMATION_TIMED_OUT',
  ...
  PreExecutionReservationFailed = 'PRE_EXECUTION_RESERVATION_FAILED',
  PriceE6NotPositive = 'PRICE_E6_NOT_POSITIVE',
  QuoteMismatch = 'QUOTE_MISMATCH',
  QuoteUnavailable = 'QUOTE_UNAVAILABLE',
  QuoteValidationTimeout = 'QUOTE_VALIDATION_TIMEOUT',
  QuoteValidationUnavailable = 'QUOTE_VALIDATION_UNAVAILABLE',
  ...
  ReplacementTransactionUnderpriced = 'REPLACEMENT_TRANSACTION_UNDERPRICED',
  RequesterAllowanceValidationFailed = 'REQUESTER_ALLOWANCE_VALIDATION_FAILED',
  RequesterAllowanceReservedByActiveRfqs = 'REQUESTER_ALLOWANCE_RESERVED_BY_ACTIVE_RFQS',
  RequesterBalanceValidationFailed = 'REQUESTER_BALANCE_VALIDATION_FAILED',
  RequesterBalanceReservedByActiveRfqs = 'REQUESTER_BALANCE_RESERVED_BY_ACTIVE_RFQS',
  RfqNotAccepted = 'RFQ_NOT_ACCEPTED',
  ...
  ExecutionHandoffFailed = 'EXECUTION_HANDOFF_FAILED',
  TradeSubmissionFailed = 'TRADE_SUBMISSION_FAILED',
  TxnReverted = 'TXN_REVERTED',
  Unauthenticated = 'UNAUTHENTICATED',
  UnauthorizedRfq = 'UNAUTHORIZED_RFQ',
  UnauthorizedRole = 'UNAUTHORIZED_ROLE',
  UnsupportedRequesterSignatureType = 'UNSUPPORTED_REQUESTER_SIGNATURE_TYPE',
...
const RfqExecutionUpdateSchema = z
  .object({
    ...
    code: RfqErrorCodeSchema.optional(),
    error: z.string().optional(),
  })
  .transform((message) => ({
    rfqId: message.rfq_id,
