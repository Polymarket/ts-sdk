...
describe('createOrderRouting', () => {
  ...
  it('routes an asset with a reserved bit set through the CTF exchange', () => {
    const assetId = toTokenId(
      (BigInt(V2_POSITION_ID) | (1n << 40n)).toString(),
    );
