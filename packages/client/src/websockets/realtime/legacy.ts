...
export type LegacyRtdsTransportOptions = {
  headers?: Record<string, string>;
  url: string;
};

/**
 * @internal Legacy realtime transport.
 *
 ...
 */
export class LegacyRtdsTransport
  implements WebSocketSubscriptionManager<RtdsSpec, RtdsEvent>
{
  ...
  constructor(options: LegacyRtdsTransportOptions) {
